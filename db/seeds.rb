...
Rechtsvorm.create(naam: 'Besloten Vennootschap', afkorting: 'B.V.', sector: 'Vennootschappen')
Rechtsvorm.create(naam: 'Naamloze Vennootschap', afkorting: 'N.V.', sector: 'Vennootschappen')
...
Rechtsvorm.create(naam: 'Vereniging met volledige rechtsbevoegdheid', afkorting: 'VMVRB', sector: 'Huishoudens')
...
Bedrijfstak.create(naam: 'Handel, horeca en reparatie', letter: 'A')
Bedrijfstak.create(naam: 'Vervoer, opslag en communicatie', letter: 'A')
Bedrijfstak.create(naam: 'Financiële en zakelijke dienstverlening', letter: 'A')
Bedrijfstak.create(naam: 'Overheid', letter: 'A')
Bedrijfstak.create(naam: 'Zorg en overige dienstverlening', letter: 'A')
Bedrijfstak.create(naam: 'yyyyyyyyyyyyy', letter: 'A')
Bedrijfstak.create(naam: 'xxxxxxxxxxxx', letter: 'A')
