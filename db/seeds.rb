...
Boeking.create("grootboekrekening_id"=>11, "journaal_id"=>1, "product_id"=>1, "datum"=>"null", "icoon"=>"null", "bij_af"=>"+", "waarde"=>100000, "p_inkoop"=>1, "hoeveelheid"=>100000, "organisatie_id"=>2, "boekingtype"=>"J", "boekproces_id"=>15)
Boeking.create("grootboekrekening_id"=>12, "journaal_id"=>1, "product_id"=>1, datum: Date.new(2016,1,7), icoon: nil, "bij_af"=>"-", "waarde"=>106000, "p_inkoop"=>0, "hoeveelheid"=>0, "organisatie_id"=>2, "boekingtype"=>"J", "boekproces_id"=>2)
...
Boekproces.create("naam"=>"Inkomsten xs", icoon: nil, "kostenspecificatie"=>nil)
