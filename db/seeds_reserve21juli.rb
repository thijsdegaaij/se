...
Grootboekrekening.create("naam"=>"Zelf gemaakt", "grootboektype_id"=>14, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/1/thumb_broodbereid.png"))
Grootboekrekening.create("naam"=>"Boodschappen houdbaar", "grootboektype_id"=>12, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/2/jam.png"))
Grootboekrekening.create("naam"=>"Vervoersspullen", "grootboektype_id"=>13, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/3/fiets.png"))
Grootboekrekening.create("naam"=>"Interieurspullen", "grootboektype_id"=>13, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/4/bed.png"))
Grootboekrekening.create("naam"=>"Kosten voor huis", "grootboektype_id"=>3, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/5/huis.png"))
Grootboekrekening.create("naam"=>"Energiekosten", "grootboektype_id"=>3, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/6/elektriciteit.jpg"))
Grootboekrekening.create("naam"=>"Schoonmakers", "grootboektype_id"=>4, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/7/figuren_peter.png"))
Grootboekrekening.create("naam"=>"Mijn huis", "grootboektype_id"=>14, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/9/interieur1.jpeg"))
Grootboekrekening.create("naam"=>"Mijn werk", "grootboektype_id"=>16, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/10/figuren_maxima.png"))
Grootboekrekening.create("naam"=>"Inkoop brood", "grootboektype_id"=>1, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/11/brood.png"))
...
Grootboekrekening.create("naam"=>"Telefoonkosten", "grootboektype_id"=>3, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/14/telefoonmobiel.jpeg"))
Grootboekrekening.create("naam"=>"Verkoop brood", "grootboektype_id"=>5, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/15/brood.png"))
...
Grootboekrekening.create("naam"=>"Machines", "grootboektype_id"=>2, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/18/oven.png"))
Grootboekrekening.create("naam"=>"Leveringskosten", "grootboektype_id"=>3, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/19/bestelbus.jpeg"))
Grootboekrekening.create("naam"=>"Advertentie", "grootboektype_id"=>7, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/20/reclameBroodBart.png"))
Grootboekrekening.create("naam"=>"Administratie", "grootboektype_id"=>17, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/21/klappers.png"))
Grootboekrekening.create("naam"=>"Boodschappen", "grootboektype_id"=>12, "organisatie_id"=>"1", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/22/brood.png"))
Grootboekrekening.create("naam"=>"Jan", "grootboektype_id"=>4, "organisatie_id"=>"2", icoon: File.open(Rails.root + "public/uploads/grootboekrekening/icoon/23/figuren_bakkerpaars.png"))
...
Grootboektype.create("naam"=>"Vlottende activa", icoon: File.open(Rails.root + "public/uploads/grootboektype/icoon/1/icon_rondje.png"), "categorie"=>"I")
Grootboektype.create("naam"=>"Vaste activa", icoon: File.open(Rails.root + "public/uploads/grootboektype/icoon/2/icon_vierkant.png"), "categorie"=>"I")
Grootboektype.create("naam"=>"Kosten", icoon: File.open(Rails.root + "public/uploads/grootboektype/icoon/3/icon_pijlhoofdmarkt.png"), "categorie"=>"I")
Grootboektype.create("naam"=>"Personeel", icoon: File.open(Rails.root + "public/uploads/grootboektype/icoon/4/icon_mens.png"), "categorie"=>"I")
Grootboektype.create("naam"=>"Verkopen", icoon: File.open(Rails.root + "public/uploads/grootboektype/icoon/5/icon_rondje.png"), "categorie"=>"O")
...
Organisatie.create("naam"=>"Maxima", "bedrijfstak_id"=>19, "rechtsvorm_id"=>1, "voorkant_image"=> File.open(Rails.root + "public/uploads/organisatie/voorkant_image/1/figuren_maxima.png"))
Organisatie.create("naam"=>"Bakker Bart", "bedrijfstak_id"=>7, "rechtsvorm_id"=>2, "voorkant_image"=> File.open(Rails.root + "public/uploads/organisatie/voorkant_image/2/bakkerbuitenkant.jpeg"))
Organisatie.create("naam"=>"MediaMarkt", "bedrijfstak_id"=>7, "rechtsvorm_id"=>10, "voorkant_image"=> File.open(Rails.root + "public/uploads/organisatie/voorkant_image/3/mediamarkt.jpg"))
Organisatie.create("naam"=>"Shell", "bedrijfstak_id"=>3, "rechtsvorm_id"=>10, "voorkant_image"=> File.open(Rails.root + "public/uploads/organisatie/voorkant_image/4/shell.jpg"))
Organisatie.create("naam"=>"Bank ING", "bedrijfstak_id"=>11, "rechtsvorm_id"=>11, "voorkant_image"=> File.open(Rails.root + "public/uploads/organisatie/voorkant_image/5/inglogo.png"))
Organisatie.create("naam"=>"Parlement", "bedrijfstak_id"=>15, "rechtsvorm_id"=>12, "voorkant_image"=> File.open(Rails.root + "public/uploads/organisatie/voorkant_image/6/parlement.jpeg"))
Product.create("naam"=>"Brood", icoon: File.open(Rails.root + "public/uploads/product/icoon/1/brood.png"))
Product.create("naam"=>"Oven", icoon: File.open(Rails.root + "public/uploads/product/icoon/2/oven.png"))
